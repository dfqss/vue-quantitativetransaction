<template>
  <div class="container">
    ...
    <div class="add-button">
      ...
      <el-button type="primary" @click="getTecAnalysisIndexList" :loading="loading">查 询</el-button>
    </div>
    ...
    <div class="table-container">
      <el-table :data="dataList" border highlight-current-row :cell-style="{ 'text-align': 'center' }">
        ...
        <el-table-column label="5日乖离率_PIT" prop="tech_bias5" />
...
export default {
  ...
  methods: {
    ...
    async hCurrentChange(curPage) {
      ...
      // 2. 重发请求
      await this.getTecAnalysisIndexList()
    },
